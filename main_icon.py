...
from pyhelpers.debug import getTrace
from pyhelpers.call import makeTransaction, makeCall
from pyhelpers.config import *
from pyhelpers.utils import utf8ToHex
...
DAPP_BSC = "0xd2C85d8D6C3c04A868dfdDFf24024e40f5ef7ad7" # bsc
...
def makeXCall():
    ...
    data = "makeMessage, 0, final message - from ICON Berlin-Net ,0x1"
    data = utf8ToHex(data)
